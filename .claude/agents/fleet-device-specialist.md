...
- `devices.yml` is the fleet's source of truth for both IP list and per-device `resolution` override consumed by the Kodi deploy pipeline — treat it as data, validate before hand-editing.
